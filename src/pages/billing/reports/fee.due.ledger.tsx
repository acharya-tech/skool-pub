...
import { UCSAutoComplete, UCSDatePicker } from "@components/input/uc.input";
import { ACADEMIC_CLASS_LIST } from "@academic/constant/urls";
import { useAutocomplete } from "@refinedev/mui";
import { IClass } from "@academic/interface";
import { FeeDueLedgerTable } from "@billing/reports/fee.due.ledger";
...
export default () => {
  ...
  return (
    ...
    >
      <FeeDueLedgerTable search={search} uptoDate={uptoDate} aclass={aclass} />
    </RefineListView>
  );
};