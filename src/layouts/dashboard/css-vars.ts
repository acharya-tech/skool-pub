...
export function dashboardLayoutVars(theme: Theme) {
  return {
    ...
    "--layout-nav-mini-width": "128px",
    "--layout-main-nav-width": "50px",
...
): Record<"main" | "layout" | "section", CSSObject | undefined> {
  const {
    vars: { palette },
  } = theme;
  ...
  switch (navColor) {
    case "integrate":
      return {
        main: {},
        layout: {
          "--layout-main-nav-bg": palette.primary.main,
          "--layout-main-nav-text-primary-color": palette.text.primary,
          "--layout-main-nav-text-active-color": palette.primary.main,
          "--layout-main-nav-bg-active-color": palette.background.default,
          "--layout-main-nav-text-disabled-color": palette.text.disabled,
    ...
    case "apparent":
      return {
        main: {
          "--layout-main-nav-bg": palette.background.default,
          "--layout-main-nav-text-primary-color": "blue",
          "--layout-main-nav-text-active-color": "#FFFFFF",
          "--layout-main-nav-bg-active-color": "blue",
          "--layout-main-nav-text-disabled-color": palette.text.disabled,
        },
        layout: {
