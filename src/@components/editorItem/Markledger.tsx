import { IItemLedgerTable, IItemSubjectTable } from "src/editor/interface";
import { Group, Rect, Text } from "react-konva";
import { ExmResultSubjectMeta, IExmResult, IExmSubject } from "../../modules/@exam/interface";
import { SubjectTypeEnum } from "@common/all.enum";
import { adjustArraySize } from "@utils/other";

type MarkledgerProps = {
    el: IItemLedgerTable;
                        ...
                        return (
                            ...
                            >
                                ...
                                <Text
                                    ...
                                    height={colHeight}
                                    wrap="word"
                                    text={subjectData?.markResult?.obtain_mark?.toString() ?? ""}
                                    fontStyle={fontStyle}
                                    fontSize={+el.fontSize}
                                    align={col.textAlign}
                                    fill={el.color}
                    ...
                    return (
                        ...
                        >
                            ...
                            <Text
                                ...
                                height={colHeight}
                                wrap="word"
                                text={subjectData?.markResult?.in_mark?.toString() ?? ""}
                                fontStyle={fontStyle}
                                fontSize={+el.fontSize}
                                align={col.textAlign}
                                fill={el.color}
                            ...
                            <Text
                                ...
                                height={colHeight}
                                wrap="word"
                                text={subjectData?.markResult?.th_mark?.toString() ?? ""}
                                fontStyle={fontStyle}
                                fontSize={+el.fontSize}
                                align={col.textAlign}
                                fill={el.color}
