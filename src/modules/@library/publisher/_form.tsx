...
import { LIBRARY_PUBLISHER_URL } from "@library/constant";
import { useRefineForm } from "@hooks/useForm";

export const PublisherForm = (props: ATFormProps) => {
  ...
  const {
    ...
    refineCore: { onFinish },
    saveButtonProps,
  } = useRefineForm<ILibPublisher, HttpError, Nullable<ILibPublisher>>({
    refineCoreProps: {
