...
import { NoticeTypeEnum, NoticeUserTypeEnum } from "../constant/enum";
...
export const EmailForm = (props: ATFormProps) => {
    ...
    const templateValue = watch("message") ?? ""
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid size={12} >
                                        ...
                                        <QuillInput
                                            ...
                                            width="100%"
                                            setEditable={(value: string) => { setValue("message", value) }}
                                        />
                                        {errors.message && (
                                            <Typography color="error">{errors?.message?.message?.toString()}</Typography>
                                        )}
                                        <CSHiddenInput name="noticeTypes.0" control={control} defaultValue={NoticeTypeEnum.Email} />
