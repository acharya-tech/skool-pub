...
import { IStudentDoc } from '../../interface';
import { STUDENT_DOC_URL } from '../../constant';
...
function DocumentView({ id }: StudentViewProps) {
    const t = useTranslate(LANG_STUDENT, "student_doc");
    const [isEditing, setEditing] = useState(false)
    const { data, isLoading } = useList<IStudentDoc>({
