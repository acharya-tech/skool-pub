...
import { STUDENT_DASHBOARD_ADMISSION_PIE_ID } from '@student/constant/constant';
...
export function AdmissionPie({ title, chart, subheader, sx, ...other }: Props) {
  ...
  const { data: chartDataRaw } = useOne<IPieReportDto>({
    ...
    id: STUDENT_DASHBOARD_ADMISSION_PIE_ID
  })
