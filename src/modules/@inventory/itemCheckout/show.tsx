...
import { INVENTORY_ITEM_CHECKOUT_URL, INVENTORY_ITEMS_URL } from "../constant";
...
export const ItemCheckoutShowModule = () => {
  const t = useTranslate(LANG_INVENTORY, "inEntry");
  const {
    query: { data, isLoading },
  } = useRefineShow<IStoreItemCheckOut>({
    resource: INVENTORY_ITEM_CHECKOUT_URL,
