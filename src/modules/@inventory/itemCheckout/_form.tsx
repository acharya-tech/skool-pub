...
import { IStoreInEntryCreate, IStoreItem, IStoreProcurement, IStoreProduct } from "../interface";
import {
...
export const ItemCheckoutForm = (props: ATFormProps) => {
  ...
  const {
    ...
    refineCoreProps: {
      meta: { customQuery: { house: true, vendor: true } },
