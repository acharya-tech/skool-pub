...
import { IStoreItem, IStoreProduct, IStoreRequisitionCreate } from "../interface";
import {
  INVENTORY_PRODUCT_LIST,
  INVENTORY_REQUISITION_URL,
} from "../constant";
...
export const RequsitionForm = (props: ATFormProps) => {
  ...
  const {
    ...
    refineCore: { onFinish },
    saveButtonProps,
  } = useRefineForm<IStoreRequisitionCreate, HttpError, Nullable<IStoreRequisitionCreate>>({
    refineCoreProps: {
      meta: { customQuery: { house: true } },
        ...
        <Grid size={12}>
          <TableContainer component={Paper} sx={{ mt: 4 }}>
            <Table>
              <TableHead>
                <TableRow>
                  <TableCell width={"50%"}>{t("fields.product_name")}</TableCell>
