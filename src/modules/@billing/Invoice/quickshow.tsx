...
import { BillingInvoiceItem } from "@components/editorItem/BillingInvoiceItem";
...
export const BillingQuickView = ({ bill, template, close }: BillingViewProps) => {
  console.log(bill,template,"Ccskdjcskdcjsd cosdicsdoicsd cosdicsdo")
  ...
  const fillers: Record<string, string | number> = {
    ...
    bill_date: dayjs(bill.bill_date).format("YYYY-MM-DD"),
    ...
    bill_taxable_amount: bill.taxable_amount,
    bill_tax_amount: bill.tax_amount,
